...
- Don't read the entire solution at once, read it step-by-step and implement it yourself.
- Learn something from every problem (e.g., new algorithm or idea, implementation trick, a bug.)
- **Understand how you could have come up with the solution yourself.**